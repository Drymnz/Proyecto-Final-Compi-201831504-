...
case 38:return 12;
break;
case 39:file.acctivar = true;texto_agregar=''; if(primera){let numero = Number(yy_.yylloc.first_line)-2; for(let i =0; i < numero;i++){texto_agregar+='\n';}primera=false;}  file.appetTexto_salida(texto_agregar+yy_.yytext);      return 31;
break;
case 40:file.acctivar = true;texto_agregar=''; if(primera){let numero = Number(yy_.yylloc.first_line)-2; for(let i =0; i < numero;i++){texto_agregar+='\n';}primera=false;}  file.appetTexto_salida(texto_agregar+yy_.yytext);      return 32;
break;
case 41:file.acctivar = true;texto_agregar=''; if(primera){let numero = Number(yy_.yylloc.first_line)-2; for(let i =0; i < numero;i++){texto_agregar+='\n';}primera=false;}  file.appetTexto_salida(texto_agregar+yy_.yytext);      return 33;
break;
case 42:file.acctivar = true;texto_agregar=''; if(primera){let numero = Number(yy_.yylloc.first_line)-2; for(let i =0; i < numero;i++){texto_agregar+='\n';}primera=false;}  file.appetTexto_salida(texto_agregar+yy_.yytext);      return 34;
break;
case 43:file.acctivar = true;texto_agregar=''; if(primera){let numero = Number(yy_.yylloc.first_line)-2; for(let i =0; i < numero;i++){texto_agregar+='\n';}primera=false;}  file.appetTexto_salida(texto_agregar+yy_.yytext);      return 35;
break;
